=== CookiesControl (Spanish legislation) ===
...
It gives your visitors the option to opt in (or leave the webpage) any third party applications such as Google Analytics or Ad Sense (check the options page and also the widget area in the dashboard). The plugin then leaves a cookie of its own to remember the user's choice until the user close its browser. 

It's based in Christian Senior's Choc Chip EU Cookie WordPress Plugin 1.0. Check the changelog to see what has been added.

Questions? Please see http://alvaro.cat/obrador/plugin-per-a-wordpress-gestio-de-cookies.html or contact details at http://playbrand.info
...
Please see the screenshoot in http://alvaro.cat/obrador/plugin-per-a-wordpress-gestio-de-cookies.html

== Changelog ==

= 0.1 =
* Changes made from Christian Senior's Choc Chip EU Cookie WordPress Plugin 1.0 include: 
...
* Changes in the expiration time of the cookie, even more in line with AEPD's guide (Spanish authority for privacy).

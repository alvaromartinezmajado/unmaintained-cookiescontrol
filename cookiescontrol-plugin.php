...
?>
	...
	<link rel="stylesheet" type="text/css" media="all" href="<?php plugins_url();?>/css/" />
        <div id="cookie-allow" >
            <?php if ($cookiescontrol_optin['buttonbartext'] == "") { echo __( 'We use cookies to improve your navigation experience. By continuing browsing this site you accept our cookies policy.', 'cookiescontrol'); } else { echo $cookiescontrol_optin['buttonbartext']; } ?>
